...
- [workitems/ACCEPTANCE-20260524-upstream-cli-107-public-smoke.md](./workitems/ACCEPTANCE-20260524-upstream-cli-107-public-smoke.md) - 记录 `navigator-upstream-cli` `1.0.7` 公共安装与 clean ClientApp bootstrap 验收：credential 链路通过，当前阻塞在 PhysicalWorker/backend capability resolver 与 CLI LocalDateTime 打印
