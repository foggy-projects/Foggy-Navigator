...
| [REL-002 Navigator Upstream CLI 1.0.24 safe-ask 发布](./workitems/REL-002-navigator-upstream-cli-1.0.24-safe-ask.md) | BUG-016 safe-ask、request-scoped BusinessFunction 空集合与 POSIX profile `0600` 的 official OBS 发布及 SIM handoff | ULTRA_EXECUTING；OBS 认证已恢复，正在生成新的 clean release |
