...
| [BUG-030 Claude 任务所有者强制中止](./workitems/BUG-030-claude-owner-force-cancel.md) | 所有用户可在二次确认后按自己的 taskId 强制中止，服务端解析并验证 Worker/PID/进程身份 | READY_FOR_SIGNOFF；Worker 0.1.13 与 Java/前端需部署后完成 live destructive smoke |
