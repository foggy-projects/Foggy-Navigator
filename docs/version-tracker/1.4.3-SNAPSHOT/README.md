...
| [REL-001 Navigator Upstream CLI 1.0.22 发布](./workitems/REL-001-navigator-upstream-cli-1.0.22.md) | GOV-002 三 lane CLI 的双平台 archive、OBS installer、commit/push 与 SIM handoff | APPROVED；不改变后端、Worker 或真实 upstream runtime |
