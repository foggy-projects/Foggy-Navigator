...
| [BUG-022 Codex app-server Worker 失败锁存恢复启动](./workitems/BUG-022-app-server-force-recovery-start.md) | 为 `stop.failed` 提供显式、精确身份约束的 force-kill-and-start 恢复命令，并发布 app-server Worker 0.3.25 | ULTRA_EXECUTING |
