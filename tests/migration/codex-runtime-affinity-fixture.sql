...
CREATE TABLE session_tasks (
    ...
    PRIMARY KEY (id),
    UNIQUE KEY uk_st_task_id (task_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO sessions (id, provider_type, provider_state_json) VALUES
    ...
    ('app-existing', 'codex-worker', '{"codexRuntimeId":"app-runtime","codexRuntimeRevision":3,"codexRuntimeType":"APP_SERVER","codexRoutingEpoch":7}');
...
UPDATE codex_tasks SET task_id = CONCAT('fixture-task-', id);

INSERT INTO session_tasks (task_id, session_id, provider_type)
SELECT ct.task_id, ct.session_id, s.provider_type
  FROM codex_tasks ct
