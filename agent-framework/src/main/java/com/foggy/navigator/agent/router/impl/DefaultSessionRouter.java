package com.foggy.navigator.agent.router.impl;

import com.foggy.navigator.agent.core.AgentInfo;
import com.foggy.navigator.agent.core.AgentRegistry;
import com.foggy.navigator.agent.protocol.route.*;
import com.foggy.navigator.agent.router.DelegationRequest;
import com.foggy.navigator.agent.router.DelegationResult;
import com.foggy.navigator.agent.router.PreconditionCheckResult;
import com.foggy.navigator.agent.router.SessionRouter;
import com.foggy.navigator.agent.session.Session;
import com.foggy.navigator.agent.session.SessionCreateRequest;
import com.foggy.navigator.agent.session.SessionManager;
import com.foggy.navigator.agent.session.SessionStatus;
