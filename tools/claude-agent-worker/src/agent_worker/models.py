...
class QueryRequest(BaseModel):
    ...
    cwd: str | None = Field(None, description="Working directory for Claude Code session")
    ...
    haiku_model: str | None = Field(None, description="Haiku model for simple tasks")
    sonnet_model: str | None = Field(None, description="Sonnet model for medium complexity tasks")
    opus_model: str | None = Field(None, description="Opus model for complex tasks")
