# Codex Agent Worker - Remote Bootstrap Installer (Windows)
...
Write-Host "=== Codex Agent Worker - Remote Installer ===" -ForegroundColor Cyan
Write-Host ""
...
$tmpDir = Join-Path ([System.IO.Path]::GetTempPath()) "codex-worker-remote-install"
...
$env:CODEX_WORKER_URL = $ReleaseBaseUrl
