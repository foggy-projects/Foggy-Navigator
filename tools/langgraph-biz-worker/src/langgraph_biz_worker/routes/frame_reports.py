...
async def get_frame_execution_report(
    ...
    context_id: str | None = Query(None, alias="context_id"),
    context_id_camel: str | None = Query(None, alias="contextId"),
    session_id: str | None = Query(None, alias="session_id"),
    session_id_camel: str | None = Query(None, alias="sessionId"),
    ...
    return read_frame_execution_report(
        ...
        conversation_id=context_id or context_id_camel,
