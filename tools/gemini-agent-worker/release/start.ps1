# Gemini Agent Worker start script (Windows)
...
Write-Host "`n[3/4] Starting Gemini Worker..." -ForegroundColor Yellow
...
if ($ready) {
    ...
    Write-Host "  Gemini Worker is READY!" -ForegroundColor Green
