...
printf '%s  %s\n' "$(sha256sum "$WINDOWS_ARCHIVE" | awk '{print $1}')" "$(basename "$WINDOWS_ARCHIVE")" > "$WINDOWS_ARCHIVE.sha256"
printf '%s  %s\n' "$(sha256sum "$LINUX_ARCHIVE" | awk '{print $1}')" "$(basename "$LINUX_ARCHIVE")" > "$LINUX_ARCHIVE.sha256"
