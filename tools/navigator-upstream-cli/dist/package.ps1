...
$features = @(
    ...
    "runtime-standard-ask-request-audit",
    "standard-ask-client-request-correlation",
    "runtime-token-standard-ask-correlation",
    ...
    "runtime-request-time-basis",
    "runtime-task-terminate",
    "runtime-task-terminate-dry-run",
    "runtime-task-reconcile",
    "runtime-task-termination-audit",
    "runtime-audit-standard-ask",
    "runtime-task-scope-at-admission",
    "runtime-task-token-revocation-audit",
    "runtime-termination-no-redispatch",
    "runtime-reconcile-no-dispatch",
    "messages",
    "sessions",
    "skill-artifact-read",
    "skill-sync",
